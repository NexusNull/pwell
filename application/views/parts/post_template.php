...
<div class="content spacer row post">
    <div class="post-menu">
        <i class="fa fa-pencil-square-o post-edit button require_perm perm_edit_post" style="display:none;" aria-hidden="true"></i>
        <i class="fa fa-check-square-o  post-edit-finished button hidden" aria-hidden="true"></i>
        <i class="fa fa-trash post-delete button require_perm perm_delete_post" style="display:none;" aria-hidden="true"></i>
    </div>
    <div>
