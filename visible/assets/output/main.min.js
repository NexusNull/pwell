...
pwell.ContentNavigator.prototype.update=function(a){var b="";if(20<a.title.length){for(var c=a.title.split(""),d=!1,e=16;15<e;e--)if(" "===c[e]){d=!0;b=c.join("").slice(0,e)+" ...";break}d||(b=c.join("").slice(0,16)+"...")}else b=a.title;this.titleDisplay.innerHTML=b;b="";for(var f in a.headings)b+="<li><a href='#p"+a.id+"_"+f+"'>"+a.headings[f]+"</a></li>";this.breadcrumbsDisplay.innerHTML="<ul>"+b+"</ul>"};pwell.post={};"undefined"==typeof pwell&&(pwell={});pwell.Post=function(a){this.data=a;this.element=null;this.buttons={};this.editor=null;this.buttons={}};
...
pwell.Post.prototype.enableEditing=function(){var a=this.element;this.buttons.postEditFinishedButton.classList.remove("hidden");this.buttons.postEditButton.classList.add("hidden");var b=a.getElementsByClassName("post-title")[0];a=a.getElementsByClassName("post-text")[0];b.classList.add("editable");b.setAttribute("contentEditable","true");this.editor=new Quill(a,{modules:{toolbar:{container:[["bold","italic","underline","strike"],["blockquote","code-block"],[{header:1},{header:2}],[{list:"ordered"},
{list:"bullet"}],[{script:"sub"},{script:"super"}],[{size:["small",!1,"large","huge"]}],[{header:[1,2,3,4,5,6,!1]}],["link","image","formula"],[{color:[]},{background:[]}],[{font:[]}],["clean"]],handlers:{image:function(){pwell.imageManager.setQuill(this.quill);$("#image_menu").modal("show")},formula:function(){console.error("Not implemented")}}}},theme:"snow"})};
...
$(this.element).find(".post-text").removeClass("ql-snow");$(this.element).find(".ql-editor").attr("contenteditable","false");$(this.element).find(".post-text").append($(".ql-editor").children());$(this.element).find(".ql-editor")[0].remove();$(this.element).find(".ql-clipboard")[0].remove();$(this.element).find(".ql-tooltip")[0].remove()}};pwell.modalController={};"undefined"===typeof pwell&&(pwell={});pwell.ModalController=function(){this.userId=0;this.username=""};pwell.ModalController.prototype.confirmBan=function(){$("#ban")};pwell.ModalController.prototype.confirmDelete=function(){$("#delete")};
...
pwell.rest.setUserPerms=function(a,b,c){null==c&&(c={error:function(){},success:function(){}});this.defaultRequest({url:"Rest/user/info",method:"GET",success:c.success,error:c.error})};pwell.rest.getImageByName=function(a,b){null==b&&(b={error:function(){},success:function(){}});this.defaultRequest({url:"Rest/media/"+encodeURIComponent(a),method:"GET",success:b.success,error:b.error})};
pwell.rest.getImageById=function(a,b){null==b&&(b={error:function(){},success:function(){}});this.defaultRequest({url:"Rest/getmedia/"+encodeURIComponent(a),method:"GET",success:b.success,error:b.error})};
pwell.rest.uploadImage=function(a,b,c){null==c&&(c={error:function(){},success:function(){}});var d=new XMLHttpRequest,e=new FormData;e.set("file",a);e.set("caption",b);d.onreadystatechange=function(a){d.readyState===XMLHttpRequest.DONE&&setTimeout(function(){200===d.status?c.success():c.error()},200)};d.open("POST","./rest/media",!0);d.send(e)};
pwell.rest.defaultRequest=function(a){null==a&&(a={error:function(){},success:function(){}});$.ajax({type:a.method,url:a.url,dataType:"json",data:a.data,success:function(b){console.log(b);var c=null,d="Operation successful";b&&("string"===typeof b.msg&&0<b.msg&&(d=b.msg),"object"===typeof b.data&&(c=b.data));"function"===typeof a.success&&a.success(d,c)},error:function(b,c,d){c=d;d=null;b.responseJSON&&("string"===typeof b.responseJSON.msg&&0<b.responseJSON.msg.length&&(c=b.responseJSON.msg),"object"===
typeof b.responseJSON.data&&(d=b.responseJSON.data));"function"===typeof a.error&&a.error(c,d)}})};pwell.controller={};"undefined"==typeof pwell&&(pwell={});pwell.Controller=function(){this.loggedin=!1;this.permissions={};this.currentUserId=0;this.postContainer=null};pwell.Controller.prototype.logout=function(){var a=this;pwell.rest.logout({success:function(){a.updateLoginInfo()}})};
...
pwell.AjaxForm=function(a,b,c,d){var e=this;this.callback=d?d:function(){};this.FormSelector=a;this.action=b;this.initialHeight=this.TimeoutId=this.status=0;this.ElementForm=$(a);this.EFormResponse=this.ElementForm.find(".form-response");this.ElementForm.resize(function(){0==e.status&&3==e.status&&e.EFormResponse.css("margin-top",-e.EFormResponse.outerHeight())});this.ElementForm.submit(function(a){a.preventDefault();a=e.ElementForm.serializeArray();var b={},d=function(a,b){2==e.status?(clearTimeout(e.TimeoutId),
e.hideResponse(function(){e.showResponse("success",a)})):e.showResponse("success",a);e.callback({status:"success",event:b});"undefined"!==typeof captchas&&"undefined"!==typeof grecaptcha&&e.useCaptcha&&grecaptcha.reset(c);e.TimeoutId=setTimeout(function(){e.hideResponse()},1E4)},f=function(a,b){2==e.status?(clearTimeout(e.TimeoutId),e.hideResponse(function(){e.showResponse("failure",a)})):e.showResponse("failure",a);e.TimeoutId=setTimeout(function(){e.hideResponse()},1E4);"undefined"!==typeof captchas&&
"undefined"!==typeof grecaptcha&&e.useCaptcha&&grecaptcha.reset(c);e.TimeoutId=setTimeout(function(){e.hideResponse()},1E4)},g;for(g in a)b[a[g].name]=a[g].value;"login"===e.action?pwell.rest.login(b.username,b.password,b["g-recaptcha-response"],{error:f,success:d}):"register"===e.action?pwell.rest.register(b.username,b.password,b.email,b["g-recaptcha-response"],{error:f,success:d}):"info"===e.action&&pwell.rest.getUserInfo(b.username,b.password,b.email,b["g-recaptcha-response"],{error:f,success:d})})};
...
$(document).ready(function(){new pwell.ModalForm("#login","#LoginForm","login",function(a){"success"===a.status&&"undefined"!==typeof pwell.controller&&"undefined"!==typeof pwell.controller.updateLoginInfo&&(pwell.controller.updateLoginInfo(),pwell.controller.updateUI())},!0);new pwell.ModalForm("#register","#RegisterForm","register",null,!0);new pwell.ModalForm("#manageUser","#ManageUserForm","info",function(a){if("success"===a.status&&(a=a.event,"success"==a.status)){var b="",c;for(c in a.data)b+=
"<div class='row'> <div class='col-xs-2' style='text-transform: capitalize'>"+c+"</div><div class='col-xs-10'>"+a.data[c]+"</div></div>";pwell.modalController.userId=a.data.id;pwell.modalController.username=a.data.name;$("#manageUser").find(".content")[0].innerHTML=b;$(".actionButtons").find("button").removeClass("disabled")}});new pwell.ModalForm("#permission","#PermissionForm","/Api/setPerms")});"undefined"==typeof pwell&&(pwell={});
pwell.ImageManager=function(){this.searchBar=$(".image-search-bar")[0];this.increment=0;this.quillInstance=this.currentSelection=null;this.image_manage=$("#image_manage");this.image_upload=$("#image_upload");this.image_menu=$("#image_menu");this.selector=this.image_manage.find(".image-selector")[0];this.imageEditor=this.image_manage.find(".image-editor-settings");this.previewImg=this.image_manage.find(".image-editor-preview-img")[0];this.previewName=this.image_manage.find(".preview-img-name")[0];this.previewDimensions=
this.image_manage.find(".preview-img-dimensions")[0];this.previewSize=this.image_manage.find(".preview-img-size")[0];this.previewFileType=this.image_manage.find(".preview-img-file-type")[0];this.chooseButton=this.image_manage.find(".image-editor-upload-button")[0]};pwell.ImageManager.prototype.search=function(a){var b=this;pwell.rest.getImageByName(a,{success:function(a,d){b.updateUI(d)},error:function(a){console.log(a)}})};
pwell.ImageManager.prototype.updateImageDisplay=function(a){var b=this;console.log(2);pwell.rest.getImageById(a,{success:function(a,d){b.currentSelection=d;$(b.previewImg).attr("src","uploads/original/"+d.file_name);a=d.size_x;var c=d.size_y,f=d.name;f.split(".");var h=d.file_type;d=pwell.util.bytesToSize(d.file_size);b.previewName.innerText=f;b.previewDimensions.innerText=a+" / "+c;b.previewSize.innerText=d;b.previewFileType.innerText=h}})};
pwell.ImageManager.prototype.updateUI=function(a){this.selector.innerHTML="";for(var b=0;b<a.length;b++){var c=a[b],d=document.createElement("div");d.classList.add("image-card");d.innerHTML='<div onclick="pwell.imageManager.updateImageDisplay('+c.id+')">\n<span></span><img src="uploads/small/'+c.filename+'" class="img-fluid">\n</div>';this.selector.appendChild(d)}};pwell.ImageManager.prototype.setQuill=function(a){this.quillInstance=a};
$(document).ready(function(){pwell.imageManager=new pwell.ImageManager;pwell.imageManager.searchBar.addEventListener("keyup",function(){var a=++pwell.imageManager.increment;setTimeout(function(){a===pwell.imageManager.increment&&pwell.imageManager.search(pwell.imageManager.searchBar.value)},250)});pwell.imageManager.chooseButton.addEventListener("click",function(){var a=pwell.imageManager;console.log(a.currentSelection);a.image_manage.modal("hide");a.currentSelection&&a.quillInstance.insertEmbed(10,
"image","/uploads/original/"+a.currentSelection.file_name)})});"undefined"==typeof pwell&&(pwell={});"undefined"==typeof pwell.util&&(pwell.util={});pwell.util.bytesToSize=function(a){if(0==a)return"0 Byte";var b=parseInt(Math.floor(Math.log(a)/Math.log(1024)));return Math.round(a/Math.pow(1024,b),2)+" "+["Bytes","KB","MB","GB","TB"][b]};
pwell.ImageUploader=function(){this.files=[];this.isUploading=!1;this.image_upload_progress=$("#image_upload_progress");this.image_manage=$("#image_manage");this.image_upload=$("#image_upload");this.image_menu=$("#image_menu");this.selector=this.image_upload.find(".image-selector")[0];this.imageEditor=this.image_upload.find(".image-editor-settings");this.previewImg=this.image_upload.find(".image-editor-preview-img")[0];this.previewName=this.image_upload.find(".preview-img-name")[0];this.previewDimensions=
this.image_upload.find(".preview-img-dimensions")[0];this.previewSize=this.image_upload.find(".preview-img-size")[0];this.previewFileType=this.image_upload.find(".preview-img-file-type")[0];this.uploadButton=this.image_upload.find(".image-editor-upload-button")[0];console.log(this.imageEditor);this.uploadButton.addEventListener("click",this.uploadImages.bind(this))};
pwell.ImageUploader.prototype.updateImageList=function(){this.selector.innerHTML="";for(var a=0;a<this.files.length;a++){var b=this.files[a],c=document.createElement("div");c.classList.add("image-card");b.element=c;c.innerHTML=b.dataURL?'<div onclick="pwell.imageController.updateImageDisplay('+a+')">\n<span></span><img src="'+b.dataURL+'" class="img-fluid">\n</div>':'<div onclick="pwell.imageController.updateImageDisplay('+a+')">\n<span></span><img src="assets/img/reload.svg" class="img-fluid">\n</div>';
this.selector.appendChild(c)}};pwell.ImageUploader.prototype.updateImageDisplay=function(a){var b=this.files[a];$(this.previewImg).attr("src",this.files[a].dataURL);var c=new Image;c.src=b.dataURL;a=c.width;c=c.height;var d=b.name,e=d.split(".");e=e[e.length-1].toLowerCase();b=pwell.util.bytesToSize(b.size);this.previewName.innerText=d;this.previewDimensions.innerText=a+" / "+c;this.previewSize.innerText=b;this.previewFileType.innerText=e};
pwell.ImageUploader.prototype.addImages=function(a){for(var b=[],c=this,d=0;d<a.length;d++)b[d]=a[d],b[d].dataURL=null,function(b,d){var e=new FileReader;e.readAsDataURL(a[b]);e.onloadend=function(){c.files[d].dataURL=this.result;var a=$(c.files[d].element).find("img");a&&a.attr("src",this.result)}}(d,d+c.files.length);this.files=this.files.concat(b);this.updateImageList()};pwell.ImageUploader.prototype.deleteImage=function(a){};
pwell.ImageUploader.prototype.uploadImages=function(){var a=this;this.isUploading=!0;this.image_upload.modal("hide");setTimeout(function(){var b=a.files.length,c=0;a.image_upload_progress.modal("show");var d=a.image_upload_progress.find(".progress-bar")[0];d.innerHTML=c+" / "+b;d.style.width=c/b*100+"%";var e=function(){console.log(c);c<b?(pwell.rest.uploadImage(a.files[c],"",{error:e,success:e}),c++,d.innerHTML=c+" / "+b,d.style.width=c/b*100+"%"):(a.image_upload_progress.modal("hide"),console.log("Finished upload."))};
console.log("Started upload of "+b+" files ...");e()},500)};var files;
$(document).ready(function(){function a(a){a.preventDefault();console.log(arguments)}pwell.imageController=new pwell.ImageUploader;var b=document.getElementById("image_upload");b.addEventListener("dragenter",a,!1);b.addEventListener("dragleave",a,!1);b.addEventListener("dragover",a,!1);b.addEventListener("drop",function(a){event.preventDefault();pwell.imageController.addImages(a.dataTransfer.files)},!1);var c=document.getElementById("image-file-input");c.addEventListener("change",function(a){pwell.imageController.addImages(c.files)},
!1)});$(document).ready(function(){jQuery("img.svg").each(function(){var a=jQuery(this),b=a.attr("id"),c=a.attr("class"),d=a.attr("src");jQuery.get(d,function(d){d=jQuery(d).find("svg");"undefined"!==typeof b&&(d=d.attr("id",b));"undefined"!==typeof c&&(d=d.attr("class",c+" replaced-svg"));d=d.removeAttr("xmlns:a");!d.attr("viewBox")&&d.attr("height")&&d.attr("width")&&d.attr("viewBox","0 0 "+d.attr("height")+" "+d.attr("width"));a.replaceWith(d)},"xml")})});
