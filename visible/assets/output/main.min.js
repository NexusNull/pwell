...
$jscomp.polyfill("Array.prototype.fill",function(a){return a?a:function(a,c,e){var b=this.length||0;0>c&&(c=Math.max(0,b+c));if(null==e||e>b)e=b;e=Number(e);0>e&&(e=Math.max(0,b+e));for(c=Number(c||0);c<e;c++)this[c]=a;return this}},"es6","es3");var pwell={postContainer:{}};"undefined"==typeof pwell&&(pwell={});
pwell.PostContainer=function(){var a=this;this.posts=[];this.element=$(".post-container")[0];this.postIds=[];this.position=0;this.top=null;this.contentNavigator=new pwell.ContentNavigator;setTimeout(function(){a.updatePosts()},5E3);setInterval(function(){var b=null,c;for(c in a.postIds){var e=a.postIds[c];a.posts[e]&&(b||(b=a.posts[e]),a.posts[e].element.getBoundingClientRect().y<.6*window.innerHeight&&(b=a.posts[e]),a.posts[e].element.classList.remove("em"))}b!==a.top&&a.contentNavigator.update(b.data);
b.element.classList.add("em");a.top=b},1E3)};
pwell.PostContainer.prototype.updatePosts=function(){var a=this;pwell.rest.getPostIds({success:function(b,c){a.postIds=c;if(a.posts.length<pwell.settings.maxPosts){b=0;c=$jscomp.makeIterator(a.postIds);for(var e=c.next();!e.done;e=c.next()){var d=e.value;!a.posts[d]&&b<pwell.settings.maxPosts&&(b++,pwell.rest.getPost(d,{success:function(b,c){"Operation successful"===b&&(b=new pwell.Post(c),a.insert(b))},error:function(b,c){"Not Found"===b?(a.postIds.splice(d,1),console.error(b+" id:"+d)):console.error(b)}}))}}},
...
pwell.rest.editPost=function(a,b,c,e){null==e&&(e={error:function(){},success:function(){}});b="data="+encodeURIComponent(JSON.stringify({title:b,text:c}));this.defaultRequest({url:"Rest/posts/"+a,data:b,method:"POST",success:e.success,error:e.error})};pwell.rest.deletePost=function(a,b){null==b&&(b={error:function(){},success:function(){}});this.defaultRequest({url:"Rest/posts/"+a,method:"DELETE",success:b.success,error:b.error})};
...
pwell.rest.defaultRequest=function(a){null==a&&(a={error:function(){},success:function(){}});$.ajax({type:a.method,url:a.url,dataType:"json",data:a.data,success:function(b){var c=null,e="Operation successful";b&&("string"===typeof b.msg&&0<b.msg&&(e=b.msg),"object"===typeof b.data&&(c=b.data));"function"===typeof a.success&&a.success(e,c)},error:function(b,c,e){c=e;e=null;b.responseJSON&&("string"===typeof b.responseJSON.msg&&0<b.responseJSON.msg.length&&(c=b.responseJSON.msg),"object"===typeof b.responseJSON.data&&
(e=b.responseJSON.data));"function"===typeof a.error&&a.error(c,e)}})};pwell.controller={};"undefined"==typeof pwell&&(pwell={});pwell.Controller=function(){this.loggedin=!1;this.permissions={};this.currentUserId=0;this.postContainer=null};pwell.Controller.prototype.logout=function(){var a=this;pwell.rest.logout({success:function(){a.updateLoginInfo()}})};
pwell.Controller.prototype.updateUI=function(){var a=this,b=$(".login-buttons"),c=$(".user-info"),e=c.find(".name-field");this.loggedin?(b.hide(),c.show(),e.html(this.name)):(b.show(),c.hide());$(".require_perm").each(function(){var b=!1,c;for(c in a.permissions)if($(this).hasClass(c)&&a.permissions[c]){$(this).show();b=!0;break}b||$(this).hide()})};
...
pwell.AjaxForm=function(a,b,c,e){var d=this;this.callback=e?e:function(){};this.FormSelector=a;this.action=b;this.initialHeight=this.TimeoutId=this.status=0;this.ElementForm=$(a);this.EFormResponse=this.ElementForm.find(".form-response");this.ElementForm.resize(function(){0==d.status&&3==d.status&&d.EFormResponse.css("margin-top",-d.EFormResponse.outerHeight())});this.ElementForm.submit(function(a){a.preventDefault();a=d.ElementForm.serializeArray();var b={},e;for(e in a)b[a[e].name]=a[e].value;"login"==
this.action?pwell.rest.login(b.username,b.password,b["g-recaptcha-response"],{error:function(a,b){2==d.status?(clearTimeout(d.TimeoutId),d.hideResponse(function(){d.showResponse("failure",a)})):d.showResponse("failure",a);d.TimeoutId=setTimeout(function(){d.hideResponse()},1E4);"undefined"!=typeof captchas&&"undefined"!=typeof grecaptcha&&d.useCaptcha&&grecaptcha.reset(c);d.TimeoutId=setTimeout(function(){d.hideResponse()},1E4)},success:function(a,b){2==d.status?(clearTimeout(d.TimeoutId),d.hideResponse(function(){d.showResponse("success",
a)})):d.showResponse("success",a);d.callback({status:"success",event:b});"undefined"!=typeof captchas&&"undefined"!=typeof grecaptcha&&d.useCaptcha&&grecaptcha.reset(c);d.TimeoutId=setTimeout(function(){d.hideResponse()},1E4)}}):pwell.rest.register(b.username,b.password,b.email,b["g-recaptcha-response"],{error:function(a){2==d.status?(clearTimeout(d.TimeoutId),d.hideResponse(function(){d.showResponse("failure",a)})):d.showResponse("failure",a);d.TimeoutId=setTimeout(function(){d.hideResponse()},1E4);
"undefined"!=typeof captchas&&"undefined"!=typeof grecaptcha&&d.useCaptcha&&grecaptcha.reset(c);d.TimeoutId=setTimeout(function(){d.hideResponse()},1E4)},success:function(a,b){2==d.status?(clearTimeout(d.TimeoutId),d.hideResponse(function(){d.showResponse("success",a)})):d.showResponse("success",a);d.callback({status:"success",event:b});"undefined"!=typeof captchas&&"undefined"!=typeof grecaptcha&&d.useCaptcha&&grecaptcha.reset(c);d.TimeoutId=setTimeout(function(){d.hideResponse()},1E4)}})})};
pwell.AjaxForm.prototype.showResponse=function(a,b,c){var e=this;"undefined"==typeof c&&(c=function(){});0==this.status&&(this.status=1,this.EFormResponse[0].innerHTML=b,e.EFormResponse.css("margin-top",-e.EFormResponse.outerHeight()),"success"==a&&this.EFormResponse.addClass("form-response-success"),"failure"==a&&this.EFormResponse.addClass("form-response-failure"),e.EFormResponse.animate({marginTop:0},500,"easeOutExpo",function(){e.status=2;c(!0)}))};
...
pwell.ModalForm=function(a,b,c,e,d){var f=this;this.ElementModal=$(a);this.captcha=this.ElementModal.find(".captcha");this.captchaId=0;this.initialized=!1;this.useCaptcha=void 0!==d?d:!1;if(0!=this.captcha.length&&d)this.ElementModal.on("shown.bs.modal",function(){f.initialized||(f.captchaId=captchas[captchas.length]=grecaptcha.render(f.captcha[0].getAttribute("id"),{sitekey:pwell.settings.siteKey,size:"normal"}),f.initialized=!0)});pwell.AjaxForm.call(this,b,c,d?this.captchaId:0,e)};
...
pwell.ModalController.prototype.permission=function(){var a=this,b=$("#permission");$.ajax({type:"POST",url:"/Api/getPerms",dataType:"json",data:"id="+a.userId,success:function(c){c=c.data;var e="",d;for(d in c)e+="<div class='row'><div class='col-xs-4'>"+d+":</div><input type='hidden' value='0' name='"+d+"'><input type='checkbox' value='1' name='"+d+"' class='col-xs-2' "+(1==c[d]?"checked":"")+"></div>";b.find("input.id")[0].value=a.userId;b.find(".content")[0].innerHTML=e;b.find(".username")[0].innerHTML=
